...
I wrote a detailed description in the pull request, why and how I did implement the current feature and you can see how per pull request the code is changing and evolving. If you're particularly curious, check out the commit history inside the branch you are in. I tried to commit as much as possible, to give you the chance, to understand how the feature evolves. 

The final app can be visited [here](https://react-todo-app-code-along-qxbm8n5cr-mpagels.vercel.app/)

I would be thrilled if you comment on the pull requests if you have any question or some suggestions for improvement. :-)
